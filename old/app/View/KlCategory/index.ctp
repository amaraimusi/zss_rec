<?php
$this->CrudBase->setModelName('KlCategory');
...
$jsList[] = 'KlCategory/index'; // 当画面専用JavaScript
...
心得カテゴリーの検索閲覧および編集する画面です。<br>
<br>

<?php
	$this->Html->addCrumb("トップ",'/');
	$this->Html->addCrumb("心得カテゴリー");
...
<!-- 検索条件入力フォーム -->
<?php echo $this->Form->create('KlCategory', array('url' => true )); ?>
<div style="clear:both"></div>
...
<div id="detail_div" style="display:none">
	...
	// --- CBBXS-1004
		...
		$this->CrudBase->inputKjText($kjs,'kj_kl_category_name','カテゴリ名');
	...
	$csv_dl_url = $this->html->webroot . 'kl_category/csv_download';
...
<!-- 一覧テーブル -->
<table id="kl_category_tbl" border="1"  class="table table-striped table-bordered table-condensed">
...
foreach($data as $i=>$ent){
	...
	$this->CrudBase->tdStr($ent,'kl_category_name');
...
<div id="ajax_crud_new_inp_form" class="panel panel-primary">
	...
	<table><tbody>
		...
		<!-- CBBXS-1006 -->
		<tr><td>カテゴリ名: </td><td>
			<input type="text" name="kl_category_name" class="valid" value=""  maxlength="64" title="64文字以内で入力してください" />
			<label class="text-danger" for="kl_category_name"></label>
		</td></tr>
...
<div id="ajax_crud_delete_form" class="panel panel-danger">
	...
	<table><tbody>
		...
		<tr><td>心得カテゴリー名: </td><td>
			<span class="kl_category_name"></span>
		</td></tr>
